...
public record AudioCallSignalResponse(String callId, String roomId, AudioCallSignalType type, String senderEmail, String senderName, String sdp, String candidate, String sdpMid, Integer sdpMLineIndex, String error) {
