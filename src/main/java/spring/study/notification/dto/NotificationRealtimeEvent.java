...
public record NotificationRealtimeEvent(Long id, Long memberId, String message, String readStatus, String notiGroup, String url, LocalDateTime registerTime, LocalDateTime updateTime) {
